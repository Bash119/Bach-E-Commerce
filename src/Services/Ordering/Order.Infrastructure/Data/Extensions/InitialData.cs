...
internal class InitialData
{
    ...
    public static IEnumerable<Ordering.Domain.Models.Order> OrdersWithItems
    {
        get
        {
            ...
            var payment1 = Payment.Of(1, "5555555555554444", "mehmet", "12/28", "355");
            var payment2 = Payment.Of(2, "8885555555554444", "john", "06/30", "222");

            var order1 = Ordering.Domain.Models.Order.Create(
            ...
            var order2 = Ordering.Domain.Models.Order.Create(
                            OrderId.Of(Guid.NewGuid()),
            ...
            return new List<Ordering.Domain.Models.Order> { order1, order2 };
        }
    }
}