    ...
    : ICommandHandler<CreateOrderCommand, CreateOrderResult>
{
    ...
    private Order CreateNewOrder(OrderDto orderDto)
    {
        ...
        var newOrder = Order.Create(
                ...
                payment: Payment.Of(orderDto.Payment.PaymentMethod, orderDto.Payment.CardNumber,orderDto.Payment.CardName, orderDto.Payment.Expiration, orderDto.Payment.Cvv)
                );
