    ...
    : ICommandHandler<UpdateOrderCommand, UpdateOrderResult>
{
    public async Task<UpdateOrderResult> Handle(UpdateOrderCommand command, CancellationToken cancellationToken)
    {
        ...
        return new UpdateOrderResult(IsSucess: true);
    }
    ...
    public void UpdateOrderWithNewValues(Order order, OrderDto orderDto)
    {
        ...
        var updatedPayment = Payment.Of(orderDto.Payment.PaymentMethod, orderDto.Payment.CardNumber, orderDto.Payment.CardName, orderDto.Payment.Expiration, orderDto.Payment.Cvv);
        order.Update(
